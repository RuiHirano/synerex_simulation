...
func main() {
	...
	option := Option{
		FileName: "pod-test-36.yaml",
		AreaCoords: []Coord{
			{Longitude: 133.971626, Latitude: 35.161499},
			{Longitude: 133.971626, Latitude: 33.152210},
			{Longitude: 136.989379, Latitude: 33.152210},
			{Longitude: 136.989379, Latitude: 35.161499},
		},
		DevideSquareNum: 6,   // 2*2 = 4 areas
