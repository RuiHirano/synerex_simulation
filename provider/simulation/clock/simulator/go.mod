module github.com/synerex/synerex_alpha/provider/simulation/scenario/simulator
...
replace (
	...
	github.com/synerex/synerex_alpha/provider/simulation/scenario/agent => ../agent
