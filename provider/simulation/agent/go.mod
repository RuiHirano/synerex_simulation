...
require (
	...
	github.com/synerex/synerex_alpha/provider/simulation/agent/algorithm v0.0.0-00010101000000-000000000000 // indirect
	github.com/synerex/synerex_alpha/provider/simulation/simutil v0.0.0-00010101000000-000000000000 // indirect
...
replace (
	...
	github.com/synerex/synerex_alpha/provider/simulation/agent/algorithm => ./algorithm
