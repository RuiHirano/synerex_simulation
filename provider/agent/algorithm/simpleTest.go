...
type SimpleRoute2 struct {
	Agents []*api.Agent
}

func NewSimpleRoute2(agents []*api.Agent) *SimpleRoute2 {
	r := &SimpleRoute2{
		Agents: agents,
	}
	return r
...
func (simple *SimpleRoute2) CalcDirectionAndDistance(startCoord *api.Coord, goalCoord *api.Coord) (float64, float64) {
...
func (simple *SimpleRoute2) CalcMovedPosition(currentPosition *api.Coord, goalPosition *api.Coord, distance float64, speed float64) *api.Coord {
...
func (simple *SimpleRoute2) DecideNextTransit(nextTransit *api.Coord, transitPoint []*api.Coord, distance float64, destination *api.Coord) *api.Coord {
	// 距離が5m以下の場合
	if distance < 5 {
...
func (simple *SimpleRoute2) CalcNextRoute(agentInfo *api.Agent) *api.Route {
...
func (simple *SimpleRoute2) CalcNextAgents() []*api.Agent {
