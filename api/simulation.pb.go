...
type SimDemand struct {
	...
	Targets []uint64   `protobuf:"varint,3,rep,packed,name=targets,proto3" json:"targets,omitempty"`
	// meta data
...
type SimSupply struct {
	...
	Targets []uint64   `protobuf:"varint,3,rep,packed,name=targets,proto3" json:"targets,omitempty"`
	// meta data
	Status StatusType `protobuf:"varint,4,opt,name=status,proto3,enum=api.StatusType" json:"status,omitempty"`
...
type SimSupply_SetAgentResponse struct {
	SetAgentResponse *SetAgentResponse `protobuf:"bytes,6,opt,name=set_agent_response,json=setAgentResponse,proto3,oneof"`
}

type SimSupply_RegistProviderResponse struct {
	RegistProviderResponse *RegistProviderResponse `protobuf:"bytes,7,opt,name=regist_provider_response,json=registProviderResponse,proto3,oneof"`
}

type SimSupply_SetClockResponse struct {
	SetClockResponse *SetClockResponse `protobuf:"bytes,8,opt,name=set_clock_response,json=setClockResponse,proto3,oneof"`
}

type SimSupply_StartClockResponse struct {
	StartClockResponse *StartClockResponse `protobuf:"bytes,9,opt,name=start_clock_response,json=startClockResponse,proto3,oneof"`
}

type SimSupply_StopClockResponse struct {
	StopClockResponse *StopClockResponse `protobuf:"bytes,10,opt,name=stop_clock_response,json=stopClockResponse,proto3,oneof"`
}

type SimSupply_ForwardClockResponse struct {
	ForwardClockResponse *ForwardClockResponse `protobuf:"bytes,11,opt,name=forward_clock_response,json=forwardClockResponse,proto3,oneof"`
}
...
var fileDescriptor_961a558581160483 = []byte{
	...
	,
}
