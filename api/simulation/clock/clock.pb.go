...
func (m *UpdateClockRequest) Reset()         { *m = UpdateClockRequest{} }
func (m *UpdateClockRequest) String() string { return proto.CompactTextString(m) }
func (*UpdateClockRequest) ProtoMessage()    {}
func (*UpdateClockRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e96fed1976809896, []int{2}
}

func (m *UpdateClockRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UpdateClockRequest.Unmarshal(m, b)
}
func (m *UpdateClockRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_UpdateClockRequest.Marshal(b, m, deterministic)
}
func (m *UpdateClockRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateClockRequest.Merge(m, src)
}
func (m *UpdateClockRequest) XXX_Size() int {
	return xxx_messageInfo_UpdateClockRequest.Size(m)
}
func (m *UpdateClockRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateClockRequest.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateClockRequest proto.InternalMessageInfo

func (m *UpdateClockRequest) GetClock() *Clock {
	if m != nil {
		return m.Clock
	}
	return nil
...
func (m *UpdateClockResponse) Reset()         { *m = UpdateClockResponse{} }
func (m *UpdateClockResponse) String() string { return proto.CompactTextString(m) }
func (*UpdateClockResponse) ProtoMessage()    {}
func (*UpdateClockResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e96fed1976809896, []int{3}
}

func (m *UpdateClockResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UpdateClockResponse.Unmarshal(m, b)
}
func (m *UpdateClockResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_UpdateClockResponse.Marshal(b, m, deterministic)
}
func (m *UpdateClockResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateClockResponse.Merge(m, src)
}
func (m *UpdateClockResponse) XXX_Size() int {
	return xxx_messageInfo_UpdateClockResponse.Size(m)
}
func (m *UpdateClockResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateClockResponse.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateClockResponse proto.InternalMessageInfo
...
func (*StopClockResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e96fed1976809896, []int{13}
}
...
type Clock struct {
	...
	StepNum              uint64   `protobuf:"varint,3,opt,name=step_num,json=stepNum,proto3" json:"step_num,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*Clock) Descriptor() ([]byte, []int) {
	return fileDescriptor_e96fed1976809896, []int{14}
}
...
func (m *Clock) GetStepNum() uint64 {
	if m != nil {
		return m.StepNum
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*UpdateClockRequest)(nil), "api.clock.UpdateClockRequest")
	proto.RegisterType((*UpdateClockResponse)(nil), "api.clock.UpdateClockResponse")
...
var fileDescriptor_e96fed1976809896 = []byte{
	...
	,
}
